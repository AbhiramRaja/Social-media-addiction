...
3. Clone the repository:
   ```bash
   git clone https://github.com/AbhiramRaja/Social-media-addiction.git
   ```
...
Repository: [https://github.com/AbhiramRaja/Social-media-addiction](https://github.com/AbhiramRaja/Social-media-addiction)
